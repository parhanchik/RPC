...
extern const MIDL_SERVER_INFO RpcInt_ServerInfo;

extern const RPC_DISPATCH_TABLE RpcInt_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE RpcInt___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x6057e1cb,0x42e5,0x42c5,{0xa5,0x3a,0xdc,0x5b,0x27,0xbe,0xd3,0xc2}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&RpcInt_v1_0_DispatchTable,
    0,
    0,
    0,
    &RpcInt_ServerInfo,
...
RPC_IF_HANDLE RpcInt_v1_0_s_ifspec = (RPC_IF_HANDLE)& RpcInt___RpcServerInterface;
...
static const MIDL_STUB_DESC RpcInt_StubDesc = 
    {
    (void *)& RpcInt___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION RpcInt_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE RpcInt_v1_0_DispatchTable = 
    {
    4,
    (RPC_DISPATCH_FUNCTION*)RpcInt_table
    };

static const SERVER_ROUTINE RpcInt_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)logon,
    (SERVER_ROUTINE)FileDelete,
    (SERVER_ROUTINE)FileDownload,
    (SERVER_ROUTINE)FileUpload
    };

static const MIDL_SERVER_INFO RpcInt_ServerInfo = 
    {
    &RpcInt_StubDesc,
    RpcInt_ServerRoutineTable,
    RPCInterface__MIDL_ProcFormatString.Format,
    RpcInt_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
